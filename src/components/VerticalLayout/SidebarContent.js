          ...
          <ul className="metismenu list-unstyled" id="side-menu">
              ...
              <ul className="sub-menu">
                <li>
                  <Link to="/ecommerce-products">
                    {this.props.t("Manage Admin users")}
                  </Link>
                </li>
                <li>
                  <Link to="/ecommerce-product-detail/1">
                    {this.props.t("Manage Admin roles")}
                  </Link>
                </li>
              </ul>
            </li>
            ...
            <li>
              ...
              <ul className="sub-menu">
                ...
                <li>
                  <Link to="/chartjs">{this.props.t("Chartjs Charts")}</Link>
                </li>
                <li>
                  <Link to="/charts-knob">
                    {this.props.t("Jquery Knob Charts")}
                  </Link>
                </li>
                <li>
                  <Link to="/charts-sparkline">
                    {this.props.t("Sparkline Charts")}
                  </Link>
                </li>
              </ul>
            </li>
