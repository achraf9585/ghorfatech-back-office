...
import { CreateEssential } from "../../apis/Essential";
...
const AddEssential = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    const response = await CreateEssential(itemName, isChecked);
    if (response) {
      toast.success("Essential Created Successfully");
      navigate("/essential");
    } else {
      toast.error("Essential Creation Failed");
    }
  };
  return (
    <React.Fragment>
      ...
      <div className="page-content">
        <Container>
          ...
          <Card>
            <CardBody>
              <h4 className="card-title">Add Essential</h4>
